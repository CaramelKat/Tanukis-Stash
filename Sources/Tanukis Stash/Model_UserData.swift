...
struct UserData: Decodable, Hashable {
	...
	let wiki_page_version_count: Int?
	let artist_version_count: Int?
	let pool_version_count: Int?
	let forum_post_count: Int?
	let comment_count: Int?
	let flag_count: Int?
	let positive_feedback_count: Int?
	let neutral_feedback_count: Int?
	let negative_feedback_count: Int?
	let upload_limit: Int?
	let profile_about: String?
	let profile_artinfo: String?
}
